...
``` title="Example request: Filter by log ID" lineNumbers
...
``` title="Example request: Filter by type" lineNumbers
...
``` title="Example request: Filter by module" lineNumbers
...
``` title="Example request: Filter by severity" lineNumbers
...
``` title="Example request: Filter with pagination" lineNumbers
