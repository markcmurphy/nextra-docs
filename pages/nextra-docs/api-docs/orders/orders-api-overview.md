...
``` title="Create an order" lineNumbers
...
``` title="Change order status" lineNumbers
...
``` title="Example request: Get order statuses"
...
``` title="Example request: Specify order customer" lineNumbers
POST https://api.bigcommerce.com/stores/{{STORE_HASH}}/v2/orders
X-Auth-Token: {{ACCESS_TOKEN}}
Content-Type: application/json
Accept: application/json
...
``` title="Example request: Get a list of customers" lineNumbers
...
``` title="Example request: add shipping addresses" lineNumbers
POST https://api.bigcommerce.com/stores/{{STORE_HASH}}/v2/orders
X-Auth-Token: {{ACCESS_TOKEN}}
Content-Type: application/json
Accept: application/json
...
``` title="Example request: Add products" lineNumbers
POST https://api.bigcommerce.com/stores/{{STORE_HASH}}/v2/orders
X-Auth-Token: {{ACCESS_TOKEN}}
Content-Type: application/json
Accept: application/json
...
``` title="Example request: Get product variants" lineNumbers
...
``` title="Example request: Create an order shipment" lineNumbers
...
``` title="Example 1: order_address_id"
POST https://api.bigcommerce.com/stores/{{STORE_HASH}}}/v2/orders/{{order_id}}/shipments
X-Auth-Token: {{ACCESS_TOKEN}}
Content-Type: application/json
Accept: application/json
...
```
&nbsp;
``` title="Example 2: different order_address_id"
POST https://api.bigcommerce.com/stores/{{STORE_HASH}}}/v2/orders/{{order_id}}/shipments
X-Auth-Token: {{ACCESS_TOKEN}}
Content-Type: application/json
Accept: application/json
...
``` title="Example request: Get shipping quotes" lineNumbers
...
``` title="Example request: Get order taxes" lineNumbers
...
``` title="Example request: Get order transactions" lineNumbers
