...
``` title="Example request: Get payment methods" lineNumbers
...
``` title="Example request: Create payment access token" lineNumbers
...
``` title="Example request: Process payment with a stored card" lineNumbers
...
``` title="Example request: Process payment with a stored PayPal account" lineNumbers
POST https://payments.bigcommerce.com/stores/{{STORE_HASH}}/payments
Accept: application/vnd.bc.v1+json
Content-Type: application/json
...
``` title="Example request: Process payment with a credit card" lineNumbers
POST https://payments.bigcommerce.com/stores/{{STORE_HASH}}/payments
Accept: application/vnd.bc.v1+json
Authorization: PAT {{PAT_TOKEN}}
Content-Type: application/json
...
``` title="Example request: Process payment and save credit card" lineNumbers
POST https://payments.bigcommerce.com/stores/{{STORE_HASH}}/payments
Accept: application/vnd.bc.v1+json
Authorization: PAT {{PAT_TOKEN}}
Content-Type: application/json
...
``` title="Example request: Create an order" lineNumbers
