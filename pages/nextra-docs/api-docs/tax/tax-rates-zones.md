...
``` title="Example request: Create tax zones" lineNumbers
...
``` title="Example request: Update tax zones" lineNumbers
...
``` title="Example request: Get tax zones" lineNumbers
...
``` title="Example request: Delete tax zones" lineNumbers
...
``` title="Example response: Delete tax zones" lineNumbers
HTTP 204 No content
```
...
``` title="Example request: Create tax rates" lineNumbers
...
``` title="Example request: Update tax rates" lineNumbers
...
``` title="Example request: Get tax rates" lineNumbers
...
``` title="Example request: Delete tax rates" lineNumbers
...
``` title="Example response: Delete tax rates" lineNumbers
HTTP 204 No content
```
