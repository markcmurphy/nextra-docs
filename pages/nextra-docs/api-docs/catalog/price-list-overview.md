...
``` title="Example request: Get all price lists" lineNumbers
...
``` title="Example request: Create a price list assignment" lineNumbers
...
``` title="Example request: Assign a price list to a customer group" lineNumbers
